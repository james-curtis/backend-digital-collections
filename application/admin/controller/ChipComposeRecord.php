 ...
 * @icon fa fa-circle-o
 */
class ChipComposeRecord extends Backend
{

    /**
     * ChipComposeRecord模型对象
     * @var \app\admin\model\ChipComposeRecord
     */
    ...
    {
        parent::_initialize();
        $this->model = new \app\admin\model\ChipComposeRecord;
    ...
    public function export()
    {
        if ($this->request->isPost()) {
            ...
            $whereIds = $ids == 'all' ? '1=1' : ['chip_compose_record.id' => ['in', explode(',', $ids)]];
            ...
            $columns = "chip_compose_record.id,users.nick_name,goods.name,goods.image,chip_compose_record.compose_num,chip_compose_record.createtime";
//            print_r($worksheet);
//            exit();
//            print_r($where);
//            exit();
